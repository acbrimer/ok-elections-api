...
class CountyElectionCandidateResult(db.Model, BaseModel):
    __tablename__ = 'county_election_candidate_results'

    id = db.Column(db.Integer, primary_key=True, autoincrement=True)
    county_election_result_id = db.Column(
        db.Integer, db.ForeignKey("county_election_results.id"))
